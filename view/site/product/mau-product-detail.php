...
<div id="product">
    <div id="product-head" class="row">
        <div id="product-img" class="col-lg-6 col-md-6 col-sm-12">
            <img src="/BookStore/public/site/images/product/<?php echo $data['prd_image']; ?>">
        </div>
        <div id="product-details" class="col-lg-6 col-md-6 col-sm-12">
            ...
            <div id="add-cart"><a href="index.php?c=cart&a=add&id=<?php echo $data['prd_id'];?>">Mua ngay</a></div>
        </div>
    </div>
